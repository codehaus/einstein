 ...
 * @author Neil Ellis
 */
public interface DispatchFacade extends Facade {

    void writeAsync(WriteContext context, MessageTuple tuple, boolean payload) throws WriteFailureRuntimeException;

    void writeAsync(WriteContext context, MessageTuple tuple, boolean payload, MessageListener listener) throws WriteFailureRuntimeException;
