...
public class OperationNotSupportedRuntimeException extends EinsteinRuntimeException {
    @I18NMessage("The provider {0} does not support the facade {1}.")
    public static final String FACADE_NOT_SUPPORTED = "facade.not.supported";


    public OperationNotSupportedRuntimeException(String name, String canonicalName) {
        super("model-api", FACADE_NOT_SUPPORTED, name, canonicalName);
    }
}
