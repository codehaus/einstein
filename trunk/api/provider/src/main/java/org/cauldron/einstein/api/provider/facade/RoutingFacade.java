 ...
 * @author Neil Ellis
 */
public interface RoutingFacade extends Facade {

    MessageTuple route(RoutingContext context, MessageTuple message, MappedExecutableGroup group) throws RoutingFailureRuntimeException;
}
