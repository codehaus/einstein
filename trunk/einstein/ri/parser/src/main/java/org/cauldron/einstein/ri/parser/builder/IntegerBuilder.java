...
import org.cauldron.einstein.ri.parser.tree.IntegerNode;

/**
 * @author Neil Ellis
 */
@org.contract4j5.contract.Contract
public class IntegerBuilder extends AbstractEinsteinNodeBuilder {
    ...
    public EinsteinNode build(EinsteinParseVisitor visitor, ASTNode astNode, EinsteinNode parent) {
        ...
        IntegerNode node = new IntegerNode(astNode);
