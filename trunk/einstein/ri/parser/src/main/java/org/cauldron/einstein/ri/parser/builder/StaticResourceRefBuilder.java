...
import org.cauldron.einstein.ri.parser.tree.StaticResourceReferenceNode;

/**
 * @author Neil Ellis
 */
@org.contract4j5.contract.Contract
public class StaticResourceRefBuilder extends AbstractEinsteinNodeBuilder {
    ...
    public EinsteinNode build(EinsteinParseVisitor visitor, ASTNode astNode, EinsteinNode parent) {
        ...
        StaticResourceReferenceNode node = new StaticResourceReferenceNode(astNode);
