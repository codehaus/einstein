...
@Contract class LifecycleRuntimeException extends EinsteinRuntimeException {

    public LifecycleRuntimeException(Throwable throwable) {
        super(throwable);
    }


    public LifecycleRuntimeException(String bundle, String message, Object... args) {
        super(bundle, message, args);    //To change body of overridden methods use File | Settings | File Templates.
    }


    public LifecycleRuntimeException(Throwable t, String bundle, String message, Object... args) {
