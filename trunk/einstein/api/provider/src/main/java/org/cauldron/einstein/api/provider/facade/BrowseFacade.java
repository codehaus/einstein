 ...
 */
@Contract
public interface BrowseFacade extends Facade {


    @Pre
    MessageTuple readNoWait(@Pre ReadContext context, boolean all, boolean message) throws ReadFailureRuntimeException;
