...
public class ProviderNotFoundRuntimeException extends EinsteinRuntimeException {

    @I18NMessage("Provider {0} could not be found.")
    public static final String PROVIDER_NOT_FOUND = "provider.not.found";


    public ProviderNotFoundRuntimeException(String provider) {
        super("model-api", PROVIDER_NOT_FOUND, provider);
    }

    public ProviderNotFoundRuntimeException(Throwable throwable) {
        super(throwable);
    }
}
