...
public class InstructionAwareContext implements RoutingContext, ProviderContext, ExecutionContext, WriteContext,
                                                URIExecutionContext, QueryContext {

    private final Instruction instruction;

    InstructionAwareContext(Instruction instruction) {
        this.instruction = instruction;
    }


    public Profile getActiveProfile() {
        return instruction.getActiveProfile();
    }


    public MessageModel getMessageFactory() {
        return instruction.getActiveProfile().getMessageModel();
    }
}
