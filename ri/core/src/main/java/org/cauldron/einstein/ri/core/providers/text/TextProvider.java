 ...
 * @author Neil Ellis
 */
@RegisterProvider(name = "text",
                  metadata = @ProviderMetaData(
                          core = @CoreMetaData(
                                  name = "text",
                                  shortDescription = "Used to create textual messages.",
                                  description = "Used to create textual messages.",
                                  syntax = "'text:'<freeform-text>",
                                  example = "<< \"text:Hello World!\";"

                          ),
                          alwaysSupported = {ReadFacade.class}
                  ))
@org.contract4j5.contract.Contract
public class TextProvider extends AbstractProvider<TextResource> implements ResourceProvider {
