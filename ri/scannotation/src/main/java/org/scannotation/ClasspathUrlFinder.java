...
public class ClasspathUrlFinder
{
    ...
    * @return
    */
   private static URL[] findResourceBases(String baseResource, ClassLoader loader)
   {
    ...
    * @return
    */
   private static URL findResourceBase(String baseResource, ClassLoader loader)
   {
   ...
   public static URL[] findClassPaths(String... paths)
   {
    ...
    {
        return System.getProperty("alt.class.path", System.getProperty("java.class.path"));
    }
