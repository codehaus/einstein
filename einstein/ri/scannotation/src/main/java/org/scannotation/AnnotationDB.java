...
/**
 * The class allows you to scan an arbitrary set of "archives" for .class files.  These class files are parsed to see
 * what annotations they use.  Two indexes are created.  The javax, java, sun, com.sun, and javassist packages will not
 * be scanned by default.
 * <p/>
 * One is a map of annotations and what classes use those annotations.   This could be used, for example, by an EJB
 * deployer to find all the EJBs contained in the archive
 * <p/>
...
//    private static final Logger log = Logger.getLogger(AnnotationDB.class);
    ...
    private final Map<String, Set<String>> annotationIndex = new HashMap<String, Set<String>>();
    private final Map<String, Set<String>> implementsIndex = new HashMap<String, Set<String>>();
    private final Map<String, Set<String>> classIndex = new HashMap<String, Set<String>>();

    private transient boolean scanClassAnnotations = true;
    private transient boolean scanMethodAnnotations = true;
    private transient boolean scanParameterAnnotations = true;
    private transient boolean scanFieldAnnotations = true;
    ...
    /**
     * This method will cross reference annotations in the annotation index with any meta-annotations that they have and
     * create additional entries as needed.  For example:
     *
     ...
     * <p/>
     * WARNING: If the annotation class has not already been scaned, this method will load all annotation classes
     * indexed as a resource so they must be in your classpath
     */
    ...
    /**
     * Sometimes you want to see if a particular class implements an interface with certain annotations After you have
     * loaded all your classpaths with the scanArchive() method, call this method to cross reference a class's
     * implemented interfaces.  The cross references will be added to the annotationIndex and classIndex indexes
     *
...
//                log.debug("NOT IGNORING " + intf);
    ...
    /**
     * returns a map keyed by the fully qualified string name of a annotation class.  The Set returne is a list of
     * classes that use that annotation somehow.
     */
    ...
    /**
     * returns a map keyed by the list of classes scanned.  The value set returned is a list of annotations used by that
     * class.
     */
        ...
        for (URL url : urls) {
            ...
            while ((stream = it.next()) != null) {
                try {
                    ...
                    //TODO: Make this a log call.
                    //System.err.println("Continuing after error while processing " + url + " " + ioe.getMessage());
                }
            }
        }
     ...
     */
    void scanClass(InputStream bits) throws IOException {
        ...
        try {
            ...
            if (cf.getInterfaces() != null) {
                ...
                intfs.addAll(Arrays.asList(cf.getInterfaces()));
