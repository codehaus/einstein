...
import org.cauldron.einstein.ri.parser.tree.UnSequencedGroupNode;

/**
 * @author Neil Ellis
 */
@org.contract4j5.contract.Contract
public class UnSequencedGroupBuilder extends AbstractEinsteinNodeBuilder {
    ...
    public EinsteinNode build(EinsteinParseVisitor visitor, ASTNode astNode, EinsteinNode parent) {
        ...
        UnSequencedGroupNode node = new UnSequencedGroupNode(astNode);
        if (parent != null) {
