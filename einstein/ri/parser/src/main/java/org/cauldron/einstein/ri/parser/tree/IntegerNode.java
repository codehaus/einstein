...
import deesel.parser.com.nodes.IntegerLiteral;
...
public class IntegerNode extends AbstractEinsteinNode implements ExpressionNode {
    public IntegerNode(ASTNode astNode) {
        super(astNode);
    }
    ...
    public COMNode toCOMNode(COMNode parent) {
        ...
        expressionNode.insert(new IntegerLiteral(astNode, new BigInteger(firstTokenImage), null));
