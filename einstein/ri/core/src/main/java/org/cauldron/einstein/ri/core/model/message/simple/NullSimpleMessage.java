...
public class NullSimpleMessage extends SimpleMessage {

    public NullSimpleMessage(Correlation executionCorrelation, MessageProperties properties) {
        super(executionCorrelation, properties, null);
    }
