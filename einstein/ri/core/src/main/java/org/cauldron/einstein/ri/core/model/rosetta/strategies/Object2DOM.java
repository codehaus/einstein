...
import org.cauldron.einstein.ri.core.model.data.xml.dom.XMLDOMDataObjectFactory;

/**
 * @author Neil Ellis
 */
@RegisterConverter(name = "object2dom", from = ObjectGraphDataModel.class, to = XMLDOMDataModel.class)
@org.contract4j5.contract.Contract
public class Object2DOM implements ConversionStrategy {

    private final static XMLDOMDataObjectFactory factory = new XMLDOMDataObjectFactory();

    public DataObject convert(DataObject object) {
        return factory.createDataObject(object.getValue());
    }
}
