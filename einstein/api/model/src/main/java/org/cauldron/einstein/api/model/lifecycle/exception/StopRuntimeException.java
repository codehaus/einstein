...
public class StopRuntimeException extends EinsteinRuntimeException {


    public StopRuntimeException(Throwable t, String bundle, String message, Object... args) {
        super(t, bundle, message, args);    //To change body of overridden methods use File | Settings | File Templates.
    }

    public StopRuntimeException(String bundle, String message, Object... args) {
